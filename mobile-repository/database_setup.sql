...
CREATE DATABASE IF NOT EXISTS mobile_repository;

-- Use the database
USE mobile_repository;
...
-- Create mobiles table for storing mobile phone data
...
INSERT INTO mobiles (name, brand, price) VALUES 
